...
@Mod("mi_mod")
public class MiModMod {
	public static final Logger LOGGER = LogManager.getLogger(MiModMod.class);
	public static final String MODID = "mi_mod";
